...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -Command "irm 'https://raw.githubusercontent.com/OkpoGo/lethal-company/main/install.ps1?v=20260602-datafolder-zip' | iex"
```
